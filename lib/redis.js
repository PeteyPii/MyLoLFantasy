...
Redis.prototype.init = function(resetThrottling, resetTempCache, resetPermCache) {
  var self = this;
...
Redis.prototype.deinit = function() {
  var self = this;
  return Q.ninvoke(self.client, 'quit');
};

Redis.prototype.resetTempCache = function() {
  var self = this;
  return Q.ninvoke(self.client, 'del', TEMP_DATA_KEY);
};

Redis.prototype.resetPermCache = function() {
  var self = this;
  return Q.ninvoke(self.client, 'del', PERM_DATA_KEY);
};

Redis.prototype.getCached = function(url) {
  var self = this;
...
Redis.prototype.setCached = function(url, body, permanent) {
  var self = this;
  return Q.ninvoke(self.client, 'hset', permanent ? PERM_DATA_KEY : TEMP_DATA_KEY, url, body);
};

Redis.prototype.lolThrottleTime = function() {
  var self = this;
...
Redis.prototype.signUpAllowed = function(ip) {
  var self = this;
...
Redis.prototype.logInAllowed = function(ip, username) {
  var self = this;
  var promises = [
...
Redis.prototype.logInSuccess = function(ip, username) {
  var self = this;
  var promises = [
...
Redis.prototype.leagueCreationAllowed = function(ip, username) {
  var self = this;
  var promises = [
...
Redis.prototype.resetPasswordAllowed = function(ip, username) {
  var self = this;
  var promises = [
...
Redis.prototype.createResetPasswordToken = function(username, token) {
  var self = this;
  var multi = self.client.multi();
...
Redis.prototype.resetPasswordTokenExists = function(token) {
  var self = this;
...
Redis.prototype.consumeResetPasswordToken = function(token) {
  var self = this;
  var multi = self.client.multi();
