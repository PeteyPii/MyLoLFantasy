...
module.exports = function(db, lol) {
  ...
  self.updateAllLeagues = function() {
    return Q.Promise(function(resolve, reject) {
      ...
      db.getAllLeagues(function(league) {
        rowsReceived++;
        self.updateStatsOfLeague(league).then(function() {
          rowsProcessed++;
  ...
  self.updateStatsOfLeague = function(league) {
    var summonerIds = [];
  ...
  function getStatsOfGames(region, summonerIds, gameIds, excludedGameIds, minStartDate) {
    ...
    var playerGameStatsPromises = summonerNames.map(function(name) {
      return lol.getSummonersRecentGames(region, summonerIds[name]).then(function(recentGames) {
