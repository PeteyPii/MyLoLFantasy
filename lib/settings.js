...
function validateSettings(settings) {
  var requiredSettings = [
    ...
    'ga_key',
    'is_prod',
    'league_creation_burst_count',
    'league_creation_burst_period',
    ...
    'password_reset_burst_count',
    'password_reset_burst_period',
  ...
  if (!_.isNumber(settings.sign_up_burst_count) || (settings.sign_up_burst_count !== settings.sign_up_burst_count | 0) || settings.sign_up_burst_count <= 0)
    throw new Error('Number of sign ups per IP during one period must be a positive integer');
  if (!_.isNumber(settings.sign_up_burst_period) || (settings.sign_up_burst_period !== settings.sign_up_burst_period | 0) || settings.sign_up_burst_period < 0)
    throw new Error('Sign up burst period must be a non-negative integer');
  ...
  if (!_.isNumber(settings.league_creation_burst_count) || (settings.league_creation_burst_count !== settings.league_creation_burst_count | 0) || settings.league_creation_burst_count <= 0)
    throw new Error('Number of league creations per account/IP during one period must be a positive integer');
  if (!_.isNumber(settings.league_creation_burst_period) || (settings.league_creation_burst_period !== settings.league_creation_burst_period | 0) || settings.league_creation_burst_period < 0)
    throw new Error('League creations burst period must be a non-negative integer');
  ...
  if (!_.isNumber(settings.password_reset_burst_count) || (settings.password_reset_burst_count !== settings.password_reset_burst_count | 0) || settings.password_reset_burst_count <= 0)
    throw new Error('Number of password reset requests per account/IP during one period must be a positive integer');
  if (!_.isNumber(settings.password_reset_burst_period) || (settings.password_reset_burst_period !== settings.password_reset_burst_period | 0) || settings.password_reset_burst_period < 0)
    throw new Error('Password reset burst period must be a non-negative integer');
