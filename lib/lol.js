...
function LoL(apiKey, requestBurstCount, requestBurstPeriod) {
  var self = this;

  self.config = {
    apiKey: settings.lol_api_key,
    requestBurstCount: settings.lol_burst_requests,
    requestBurstPeriod: settings.lol_burst_period,
  };
